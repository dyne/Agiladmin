...
var app = function () {
    ...
    self.project = function(){ return("agiladmin")}; // ko.observable("no project");
    ...
    var setBlankWorksheet = function () {
        ...
        ws.segments().push(
            ...
            freeSegment("# agiladmin\n\n Welcome :-)\n\nShift + Enter will execute code. " +
						"For options, press " + ck + "+g two times or use the menu icon above to the right" +
                "\n\nTo load worksheets, use " + ck + "+g " + ck + "+l and select them (they are found in ws/)")
        );
