...
(fact "Load all projects"
      ...
      (set (keys all-pjs)) => #{:DIRECT :DUE :TRE :UNO}
      (get-in all-pjs [:DIRECT :cph]) => 25
      (get-in all-pjs [:UNO :cph]) => 45
      (get-in all-pjs [:DUE :rates :L.Pacioli]) => 30
      (get-in all-pjs [:TRE :tasks 0 :id]) => "ALPHA"
      ...
      (fact "derive project costs"
            ...
            (print costs)
            costs => {:column-names [:month :name :project :task :tag :hours :cost], :rows [{:cost 2160.0, :hours 54.0, :month "2016-1", :name "L.Pacioli", :project "UNO", :tag "", :task ""} {:cost 4720.0, :hours 118.0, :month "2016-2", :name "L.Pacioli", :project "UNO", :tag "", :task ""} {:cost 1920.0, :hours 48.0, :month "2016-3", :name "L.Pacioli", :project "UNO", :tag "", :task ""} {:cost 2000.0, :hours 50.0, :month "2016-4", :name "L.Pacioli", :project "UNO", :tag "", :task ""} {:cost 5940.0, :hours 148.5, :month "2016-5", :name "L.Pacioli", :project "UNO", :tag "", :task ""} {:cost 2000.0, :hours 50.0, :month "2016-6", :name "L.Pacioli", :project "UNO", :tag "", :task ""} {:cost 1680.0, :hours 42.0, :month "2016-7", :name "L.Pacioli", :project "UNO", :tag "", :task ""} {:cost 450.0, :hours 15.0, :month "2016-7", :name "L.Pacioli", :project "DUE", :tag "", :task "ALPHA"} {:cost 960.0, :hours 24.0, :month "2016-8", :name "L.Pacioli", :project "UNO", :tag "", :task ""} {:cost 2880.0, :hours 72.0, :month "2016-9", :name "L.Pacioli", :project "UNO", :tag "", :task ""} {:cost 900.0, :hours 30.0, :month "2016-9", :name "L.Pacioli", :project "DUE", :tag "", :task "BETA"} {:cost 1470.0, :hours 49.0, :month "2016-9", :name "L.Pacioli", :project "DUE", :tag "", :task "GAMMA"} {:cost 4080.0, :hours 102.0, :month "2016-10", :name "L.Pacioli", :project "UNO", :tag "", :task ""} {:cost 2200.0, :hours 55.0, :month "2016-11", :name "L.Pacioli", :project "UNO", :tag "", :task ""} {:cost 0, :hours 16.0, :month "2016-11", :name "L.Pacioli", :project "DUE", :tag "VOL", :task ""} {:cost 1960.0, :hours 49.0, :month "2016-12", :name "L.Pacioli", :project "UNO", :tag "", :task "ALPHA"} {:cost 0, :hours 10.0, :month "2016-12", :name "L.Pacioli", :project "DUE", :tag "VOL", :task "BETA"} {:cost 1680.0, :hours 48.0, :month "2016-12", :name "L.Pacioli", :project "TRE", :tag "", :task "GAMMA"} {:cost 0, :hours 32.0, :month "2016-12", :name "L.Pacioli", :project "QUATTRO", :tag "VOL", :task "DELTA"}]}))
